<form action="options.php" method="post">
  ...
  <div>
    <p>
      <?php _e( 'Custom fields provide the ability to show additional details about a book. Every custom field entered here will be shown in the <em>Book Info</em> section when editing a post. Click the <em>Add Field</em> button to add a new field, or drag and drop existing fields to reorder them.', $this->plugin_name ); ?>
    </p>
    <p>
