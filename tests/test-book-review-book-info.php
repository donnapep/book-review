...
class Book_Review_Book_Info_Tests extends WP_UnitTestCase {
  ...
  /**
   * @covers Book_Review_Admin::get_book_review_isbn
   */
  ...
  /**
   * @covers Book_Review_Admin::get_book_review_title
   */
  ...
  /**
   * @covers Book_Review_Admin::get_book_review_series
   */
  ...
  /**
   * @covers Book_Review_Admin::get_book_review_author
   */
  ...
  /**
   * @covers Book_Review_Admin::get_book_review_genre
   */
  ...
  /**
   * @covers Book_Review_Admin::get_book_review_publisher
   */
  ...
  /**
   * @covers Book_Review_Admin::get_book_review_release_date
   */
  ...
  /**
   * @covers Book_Review_Admin::get_book_review_format
   */
  ...
  /**
   * @covers Book_Review_Admin::get_book_review_pages
   */
  ...
  /**
   * @covers Book_Review_Admin::get_book_review_source
   */
  ...
  /**
   * @covers Book_Review_Admin::get_book_review_field
   */
  ...
  /**
   * @covers Book_Review_Admin::get_book_review_links
   */
  public function testLinks() {
    ...
    $links = $this->book_info->get_book_review_links( $this->post_id );
  ...
  public function testNoLinks() {
    ...
    $this->assertSame( array(), $this->book_info->get_book_review_links( $this->post_id ) );

    $this->drop_tables();
  }

  /**
   * @covers Book_Review_Admin::get_book_review_cover_url
   */
  ...
  /**
   * @covers Book_Review_Admin::get_book_review_summary
   */
  ...
  /**
   * @covers Book_Review_Admin::get_book_review_rating
   */
  ...
  /**
   * @covers Book_Review_Admin::get_book_review_rating_image
   */
  ...
  /**
   * @covers Book_Review_Admin::get_book_review_archive_post
   */
